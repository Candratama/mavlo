...
<p class="text-muted-foreground mt-2 text-sm">Enter your email and we'll send a reset link.</p>

{#if form?.sent}
	<p class="mt-6 text-sm">
		If your email is registered, a reset link has been sent. Check your inbox.
	</p>
